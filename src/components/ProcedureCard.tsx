    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <div className="flex items-center gap-2 text-gray-600">
          ...
          <span className="text-sm font-medium">R$ {procedure.precoSugerido.toFixed(0)}</span>
        </div>
        <div className="flex items-center gap-2 text-gray-600">
          <Users className="w-4 h-4" />
          <span className="text-sm">{procedure.numeroSessoes} sessão{procedure.numeroSessoes > 1 ? 'ões' : ''}</span>
        </div>
        <div className="flex items-center gap-2 text-gray-600">
